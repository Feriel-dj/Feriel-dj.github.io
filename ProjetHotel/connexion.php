...
<?php
if (isset($_SESSION["newinscription"])and $_SESSION["newinscription"]==true) {
    echo('<script> alert("votre inscription est ajouter, veuillez connectez avec votre mot de passe")</script>');
...
?>
   ...
   <form id="formulaire" action="traitementconnexion.php" method="POST" class="form-inline" >
