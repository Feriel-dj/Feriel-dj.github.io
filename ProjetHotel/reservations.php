...
<body>
    ...
    <?php
    if (isset($_SESSION["newreservation"])and $_SESSION["newreservation"]==true ) {
        echo('<script> alert("reservation bien reussie")</script>');
        $_SESSION["newreservation"]=null;
       
    }elseif(isset ($_SESSION["newreservation"]) and $_SESSION["newreservation"]==false){
        echo('<script> alert("reservation echouer")</script>');
        $_SESSION["newreservation"]=null;
    }
    ?>
    ...
    <div class="container">
        ...
        <div class="col-xs-offset-3 col-xs-6">
            ...
            id="form" class="form-horizontal text-center">
                <div>
