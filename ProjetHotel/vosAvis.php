...
<body>
    ...
    <div class="container">
        ...
        <div id="avis" class="avis">
                <form id="formulaire" class="form-inline" method="post" action="traitementvosavie.php">
                ...
                $avis=$bdd->query("SELECT * FROM vosavis ORDER BY comment_date desc");
                while ($donner= $avis->fetch()) {
                  echo("<h2>" .$donner["psudo"]. "</h2> <p>" .$donner["messages"]."</p>
                  <blockquote>" .$donner["comment_date"]. "</blockquote>");
                }
